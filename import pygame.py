...
# Load sound
sound = pygame.mixer.Sound("Voicy_I'll take a potato chip...and EAT IT.mp3")
...
running = True
screen.fill((0, 0, 0))
screen.blit(font1.render("I'll Take", True, (255, 255, 0)), (1, 50))
screen.blit(font3.render("a Potato", True, (255, 255, 0)), (140, 50))
screen.blit(font4.render("Chip...", True, (255, 255, 0)), (305, 55))
